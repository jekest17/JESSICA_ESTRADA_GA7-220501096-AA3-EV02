<%-- 
    ...
    Created on : 10/09/2024, 3:51:03 p. m.
    Author     : jjer1
--%>
...
<head>
    ...
    <title>Restablecer Contraseña - CyberShield AI</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-form">
            ...
            <p>¿Recordaste tu contraseña? <a href="index.html" class="create-account-link">Inicia sesión aquí</a></p>
        </div>
