<%-- 
    Document   : comunicacionSegura
    Created on : 10/09/2024, 1:10:37 p. m.
    Author     : jjer1
--%>
...
<head>
    ...
    <title>Comunicación Segura - CyberShield AI</title>
    <style>
        /* Estilos Generales */
        body {
            margin: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <!-- Encabezado -->
            <div class="header">
                <h1>Comunicación Segura</h1>
            </div>

            <!-- Tabla de Mensajes Seguros -->
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>Transferencia de archivos cifrada enviada a usuario externo</td>
                            <td>Usuario F</td>
                            <td>Cliente XYZ</td>
                            <td>2024-05-10 09:00 AM</td>
                        </tr>
                        <tr>
                            <td>Confirmación de inicio de sesión exitoso desde ubicación desconocida</td>
                            <td>Usuario G</td>
                            <td>N/A</td>
                            <td>2024-05-09 16:30 PM</td>
                        </tr>
                    </tbody>
                </table>
            </div>
